//+------------------------------------------------------------------+
//| Change of Direction V7.mq5                                       |
//| Reversal strategy — 4-phase state machine                        |
//| V7: Additional validation - ANY candle after 1st invalidates     |
//+------------------------------------------------------------------+
#property strict
#property version     "7.0"
#property description "Change of Direction V7 — Enhanced pullback validation"
